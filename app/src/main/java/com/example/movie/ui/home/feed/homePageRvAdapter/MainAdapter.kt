...
class MainAdapter(private val collection: List<TMDBResponse>, private val navController: NavController) : RecyclerView.Adapter<MainAdapter.CollectionViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CollectionViewHolder, position: Int) {
        holder.binding.apply {
            ...
            val movieAdapter = MovieAdapter(response.results, navController)
